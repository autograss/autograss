...
#     Here we configure the GPIO settings for the left and right motors
# spinning direction.
#     It defines the four GPIO pins used as input on the L298 H-Bridge to set
# the motor mode (forward, reverse and stopp).
...
#     Here we configure the GPIO settings for the left and right motors
# spinning speed.
#     It defines the two GPIO pins used as input on the L298 H-Bridge to set
# the motor speed with a PWM signal.
...
def setMotorMode(motor, mode):
    ...
    # setMotorMode(leftmotor, reverse)	-> The left motor is called by a
    # function and set into reverse mode

    # setMotorMode(rightmotor, stopp)	-> The right motor is called by a
    # function and set into stopp mode
